...
/* harmony import */ var _views_formLog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/formLog */ "./js/views/formLog.js");
/* harmony import */ var _views_tabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/tabs */ "./js/views/tabs.js");
...
/* harmony import */ var _views_notification__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/notification */ "./js/views/notification.js");
/* harmony import */ var _views_formReg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./views/formReg */ "./js/views/formReg.js");
/* harmony import */ var _services_cities_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./services/cities.service */ "./js/services/cities.service.js");
/* harmony import */ var jquery_ui_bundle__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! jquery-ui-bundle */ "../node_modules/jquery-ui-bundle/jquery-ui.js");
/* harmony import */ var jquery_ui_bundle__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(jquery_ui_bundle__WEBPACK_IMPORTED_MODULE_11__);
...
var tab = new _views_tabs__WEBPACK_IMPORTED_MODULE_5__["Tabs"](); //*Calls
//* Events

_views_formReg__WEBPACK_IMPORTED_MODULE_9__["default"].countryInput.addEventListener('blur', function () {
  Object(_services_cities_service__WEBPACK_IMPORTED_MODULE_10__["getCountries"])().then(function (response) {
    return Object(_services_cities_service__WEBPACK_IMPORTED_MODULE_10__["getElementIndex"])(response, _views_formReg__WEBPACK_IMPORTED_MODULE_9__["default"].countryInput.value);
  }).then(function (index) {
    return Object(_services_cities_service__WEBPACK_IMPORTED_MODULE_10__["getCitiesByCountryIndex"])(index);
  }).then(function (cities) {
    _views_formReg__WEBPACK_IMPORTED_MODULE_9__["default"].cityInput.removeAttribute('disabled');
    jquery__WEBPACK_IMPORTED_MODULE_12___default()(_views_formReg__WEBPACK_IMPORTED_MODULE_9__["default"].cityInput).autocomplete({
      source: cities
    });
  })["catch"](function (error) {
...
_views_formReg__WEBPACK_IMPORTED_MODULE_9__["default"].form.addEventListener('submit', function (event) {
  event.preventDefault();
  Object(_services_reg_service__WEBPACK_IMPORTED_MODULE_7__["reg"])(_views_formReg__WEBPACK_IMPORTED_MODULE_9__["default"].getObjFromForm()).then(function (res) {
    Object(_views_notification__WEBPACK_IMPORTED_MODULE_8__["notify"])({
      message: 'success',
      className: 'alert-primary'
    });
    _views_formReg__WEBPACK_IMPORTED_MODULE_9__["default"].form.reset();
  })["catch"](function (err) {
    return Object(_views_notification__WEBPACK_IMPORTED_MODULE_8__["notify"])({
      message: 'error',
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            isValidForm = inputs.every(function (input) {
              var isValidInput = Object(_helpers_validate__WEBPACK_IMPORTED_MODULE_3__["validate"])(input);
              if (!isValidInput) Object(_views_formLog__WEBPACK_IMPORTED_MODULE_4__["showInputError"])(input);
              return isValidInput;
            });
...
inputs.forEach(function (input) {
  return input.addEventListener('focus', function () {
    return Object(_views_formLog__WEBPACK_IMPORTED_MODULE_4__["removeInputError"])(input);
  });
}); //*Functions
...
function validate(element) {
  var regExp = element.dataset.required;
  if (!regExpDic[regExp]) return true;
  return regExpDic[regExp].test(element.value);
}
...
function setTocken(req) {
  if (!req.config.url.includes('auth')) {
    var token = localStorage.getItem('lsTocken');
...
function setTockenOnLogIn(res) {
  ...
  if (isLoginUrl) localStorage.setItem('lsTocken', res.data.token);
  return res;
}
...
/***/ "./js/services/cities.service.js":
/*!***************************************!*\
  !*** ./js/services/cities.service.js ***!
  \***************************************/
/*! exports provided: getCountries, getCitiesByCountryIndex, getElementIndex */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCountries", function() { return getCountries; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCitiesByCountryIndex", function() { return getCitiesByCountryIndex; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getElementIndex", function() { return getElementIndex; });
/* harmony import */ var _plugins_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../plugins/axios */ "./js/plugins/axios/index.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
function getCitiesByCountryIndex(_x) {
  return _getCitiesByCountryIndex.apply(this, arguments);
}

function _getCitiesByCountryIndex() {
  _getCitiesByCountryIndex = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(index) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _plugins_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("location/get-cities/".concat(index));
...
function getElementIndex(obj, element) {
  for (var key in obj) {
...
function _reg() {
  _reg = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
function inputErrorTemplate(message) {
  return "<div class=\"invalid-feedback\">".concat(message, "</div>");
}
...
var FormReg = /*#__PURE__*/function () {
  function FormReg() {
    _classCallCheck(this, FormReg);
  ...
  _createClass(FormReg, [{
    key: "getArrayFromInputs",
    value: function getArrayFromInputs() {
      var arr = [];
...
function alertTemplate(message, className, index) {
  return "\n        <div class=\"alert ".concat(className, "\" data-index=\"").concat(index, "\">          ").concat(message, "\n        </div>\n    ");
}
...
function notify() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      timeOut = _ref$timeOut === void 0 ? 4000 : _ref$timeOut;
...
function closeNotify(index) {
  var alert;
  if (index === undefined) alert = document.querySelector('.notify-container .alert');else alert = document.querySelector(".notify-container .alert[data-index=\"".concat(index, "\"]"));
...
var Tabs = /*#__PURE__*/function () {
  function Tabs() {
    ...
    this.frontLayer.addEventListener('click', function () {
      _this.slideFrontLayer();
    });
  ...
  _createClass(Tabs, [{
    key: "slideFrontLayer",
    value: function slideFrontLayer() {
...
/******/ });
//# sourceMappingURL=app.71780c10715c32ee1f83.js.map